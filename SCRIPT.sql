...
ALTER TABLE TbAluno ADD DaNascimento DATE;
ALTER TABLE TbAluno ADD NuCPF VARCHAR(11);
ALTER TABLE TbAluno ADD InGenero TINYINT;

UPDATE TbAluno SET DaNascimento = '1992-09-26', NuCPF = '62449752005' WHERE NuMatricula = 1;
UPDATE TbAluno SET DaNascimento = '1993-02-15', NuCPF = '29254544027' WHERE NuMatricula = 2;
UPDATE TbAluno SET DaNascimento = '1994-03-21', NuCPF = '32253895016' WHERE NuMatricula = 3;
UPDATE TbAluno SET DaNascimento = '1995-01-28', NuCPF = '43604478090' WHERE NuMatricula = 4;
UPDATE TbAluno SET DaNascimento = '1996-03-30', NuCPF = '73757633059' WHERE NuMatricula = 5;
UPDATE TbAluno SET DaNascimento = '1997-04-14', NuCPF = '33767639092', InGenero = 1 WHERE NuMatricula = 6; 
UPDATE TbAluno SET DaNascimento = '1998-05-19', NuCPF = '72618647068', InGenero = 1 WHERE NuMatricula = 7;
UPDATE TbAluno SET DaNascimento = '1999-06-20', NuCPF = '47619703080', InGenero = 2 WHERE NuMatricula = 8;
UPDATE TbAluno SET DaNascimento = '2000-07-25', NuCPF = '08725648004', InGenero = 1 WHERE NuMatricula = 9;
UPDATE TbAluno SET DaNascimento = '2001-08-24', NuCPF = '20375651004', InGenero = 1 WHERE NuMatricula = 10;
UPDATE TbAluno SET DaNascimento = '2002-09-22', NuCPF = '16515958013', InGenero = 2 WHERE NuMatricula = 11;
UPDATE TbAluno SET DaNascimento = '2003-10-19', NuCPF = '06283608000', InGenero = 1 WHERE NuMatricula = 12;
UPDATE TbAluno SET DaNascimento = '2000-11-13', NuCPF = '65645101014', InGenero = 1 WHERE NuMatricula = 13;
UPDATE TbAluno SET DaNascimento = '2001-12-11', NuCPF = '65654231057', InGenero = 1 WHERE NuMatricula = 14;
UPDATE TbAluno SET DaNascimento = '2002-01-12', NuCPF = '15326221047', InGenero = 1 WHERE NuMatricula = 15;
UPDATE TbAluno SET DaNascimento = '2006-02-14', NuCPF = '07954857000', InGenero = 1 WHERE NuMatricula = 16;
UPDATE TbAluno SET DaNascimento = '2005-03-19', NuCPF = '66514980023', InGenero = 2 WHERE NuMatricula = 17;
UPDATE TbAluno SET DaNascimento = '2004-04-27', NuCPF = '92818749034', InGenero = 2 WHERE NuMatricula = 18;
UPDATE TbAluno SET DaNascimento = '2000-05-28', NuCPF = '95958652060', InGenero = 2 WHERE NuMatricula = 19;
UPDATE TbAluno SET DaNascimento = '2002-06-22', NuCPF = '25493564033', InGenero = 2 WHERE NuMatricula = 20;
UPDATE TbAluno SET DaNascimento = '2002-07-21', NuCPF = '01277316015', InGenero = 2 WHERE NuMatricula = 21;
UPDATE TbAluno SET DaNascimento = '2001-08-11', NuCPF = '67589469084', InGenero = 1 WHERE NuMatricula = 22;
UPDATE TbAluno SET DaNascimento = '2004-09-13', NuCPF = '46008798058', InGenero = 2 WHERE NuMatricula = 23;
UPDATE TbAluno SET DaNascimento = '2000-10-01', NuCPF = '90164227067', InGenero = 2 WHERE NuMatricula = 24;
UPDATE TbAluno SET DaNascimento = '2003-11-21', NuCPF = '64350086048', InGenero = 1 WHERE NuMatricula = 25;
 
ALTER TABLE TbAluno MODIFY COLUMN DaNascimento DATE NOT NULL;
ALTER TABLE TbAluno MODIFY COLUMN NuCPF VARCHAR(11) NOT NULL UNIQUE;
